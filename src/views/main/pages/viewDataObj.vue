  ...
  <div class="resource">
    ...
    >
      ...
      >
        ...
        <el-form-item label="引用字典对象："  v-show="viewAdd.data.type=='字典'">
          <el-select
        ...
        <el-form-item
          label="是否为空："
          v-show="viewAdd.data.indexType!='主键'"
        >
          <template>
            <el-radio
    ...
    >
      ...
      >
        ...
        <el-form-item
          label="是否为空："
          prop="isNull"
          v-show="viewEdit.data.indexType!='主键'"
        >
          <template>
            <el-radio
    ...
    <div style="width:100%;position:absolute;bottom:0px;left:0%;text-align:center;">
      <dictBindAttr v-if="viewDict" :resId="resId"></dictBindAttr>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      addrules: {
        ...
        name: [{ required: true, validator: chineses, trigger: "blur" }],
  ...
  watch:{
    'viewEdit.data.type'(val){
      console.log("字典类型",val)
      if(val!="字典"){
        this.viewEdit.data.dicRes = '';
      }
    },
    'viewAdd.data.type'(val){
      console.log("字典类型",val)
      if(val!="字典"){
        this.viewAdd.data.dicRes = '';
      }
    }
  }
};
