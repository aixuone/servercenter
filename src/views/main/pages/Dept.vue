  ...
  <div class="resource">
    ...
    <div class="viewTableClass">
      <el-table :data="viewTable.data" border :header-cell-style="{background:'#f9fafc'}">
        <el-table-column prop="name" label="名称" width="150">名称</el-table-column>
        <el-table-column prop="addr" label="地址" width="150">地址</el-table-column>
        <el-table-column prop="phone" label="联系电话" width="150">联系电话</el-table-column>
    ...
    <el-dialog title="创建数据对象" :visible.sync="viewSearch.show" width="30%" id="viewSearch">
      <el-form :model="viewSearch.data" label-position="right" label-width="120px">
        ...
        <el-form-item label="名称" prop="name">
          <el-input v-model="viewSearch.data.name" placeholder="请输入名称"></el-input>
        </el-form-item>
        <el-form-item label="地址" prop="addr">
          <el-input v-model="viewSearch.data.addr" placeholder="请输入地址"></el-input>
        </el-form-item>
        <el-form-item label="联系电话" prop="phone">
          <el-input v-model="viewSearch.data.phone" placeholder="请输入联系电话"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="创建数据对象" :visible.sync="viewAdd.show" width="30%" id="viewAdd">
      <el-form :model="viewAdd.data" label-position="right" label-width="120px">
        ...
        <el-form-item label="地址" prop="addr">
          <el-input v-model="viewAdd.data.addr" placeholder="请输入地址"></el-input>
        </el-form-item>
        <el-form-item label="联系电话" prop="phone">
          <el-input v-model="viewAdd.data.phone" placeholder="请输入联系电话"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
    ...
    <el-dialog title="修改数据集属性" :visible.sync="viewEdit.show" width="30%" id="viewEdit">
      <el-form :model="viewEdit.data" label-position="right" label-width="120px">
        ...
        <el-form-item label="地址" prop="addr">
          <el-input v-model="viewEdit.data.addr" placeholder="请输入地址"></el-input>
        </el-form-item>
        <el-form-item label="联系电话" prop="phone">
          <el-input v-model="viewEdit.data.phone" placeholder="请输入联系电话"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
<script>
  ...
  methods: {
    ...
    editSingle()
    {
      axios.post('http://127.0.0.1:19062/dept/update', this.viewEdit.data)
        .then(res => {
        if(res.data.success)
      {
    ...
    deletSingle()
    {
      axios.post('http://127.0.0.1:19062/dept/delete', this.viewDelet.data)
        .then(res => {
        if(res.data.success){
    ...
    addSingle()
    {
      ...
      axios.post('http://127.0.0.1:19062/dept/add', params)
        .then(res => {
          if(res.data.success)
          {
  ...
  ,
    ...
    getTableData(params)
    {
      axios.post('http://127.0.0.1:19062/dept/list', params).then(res => {
        if(res.data.success)
      {
