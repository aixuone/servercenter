    ...
    <div class="resource">
        ...
        <div class="viewTableClass">
            <el-table :data="viewTable.data" border :header-cell-style="{background:'#f9fafc'}">
                <el-table-column prop="carname" label="车辆名称" width="150"></el-table-column>
                <el-table-column prop="carno" label="车牌号" width="150"></el-table-column>
                 <el-table-column prop="cardate" label="出厂日期" width="150"></el-table-column>
        ...
        <el-dialog title="创建数据对象" :visible.sync="viewSearch.show" width="30%" id="viewSearch">
            <el-form :model="viewSearch.data" label-position="right" label-width="120px">
                        <el-form-item label="车辆名称" prop="carname">
                            <el-input v-model="viewSearch.data.carname" placeholder="请输入车辆名称"></el-input>
                        </el-form-item>
                        <el-form-item label="车牌号" prop="carno">
                            <el-input v-model="viewSearch.data.carno" placeholder="请输入车牌号"></el-input>
                        </el-form-item>
                        <el-form-item label="出厂日期" prop="cardate">
                            <el-input v-model="viewSearch.data.cardate" placeholder="请输入出厂日期"></el-input>
                        </el-form-item>
            </el-form>
        ...
        <el-dialog title="创建数据对象" :visible.sync="viewAdd.show" width="30%" id="viewAdd">
            <el-form :model="viewAdd.data" label-position="right" label-width="120px">
                        <el-form-item label="车辆名称" prop="carname">
                            <el-input v-model="viewAdd.data.carname" placeholder="请输入车辆名称"></el-input>
                        </el-form-item>
                        <el-form-item label="车牌号" prop="carno">
                            <el-input v-model="viewAdd.data.carno" placeholder="请输入车牌号"></el-input>
                        </el-form-item>
                        <el-form-item label="出厂日期" prop="cardate">
                            <el-input v-model="viewAdd.data.cardate" placeholder="请输入出厂日期"></el-input>
                        </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
        ...
        <el-dialog title="修改数据集属性" :visible.sync="viewEdit.show" width="30%" id="viewEdit">
            <el-form :model="viewEdit.data" label-position="right" label-width="120px">
                        <el-form-item label="车辆名称" prop="carname">
                            <el-input v-model="viewEdit.data.carname" placeholder="请输入车辆名称"></el-input>
                        </el-form-item>
                        <el-form-item label="车牌号" prop="carno">
                            <el-input v-model="viewEdit.data.carno" placeholder="请输入车牌号"></el-input>
                        </el-form-item>
                        <el-form-item label="出厂日期" prop="cardate">
                            <el-input v-model="viewEdit.data.cardate" placeholder="请输入出厂日期"></el-input>
                        </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
...
<script>
    ...
    methods: {
      ...
      editSingle()
      {
        axios.post(this.base_url+'/carinfo/update', {
          dataObjectId: this.dataObjectId,
          data: this.viewEdit.data,
          condition: [

            {key: 'carno', condition: 'equals', value: this.viewEdit.old.carno}
        ...
        deletSingle()
        {
          axios.post(this.base_url+'/carinfo/delete', {
            dataObjectId: this.dataObjectId,
            condition: [
              {key: 'carno', condition: 'equals', value: this.viewDelet.data.carno}
            ]
        })
        .then(res => {
          if(res.data.success)
        ...
        addSingle()
        {
            ...
            axios.post(this.base_url+'/carinfo/add', params)
                    .then(res => {
                        if(res.data.success)
                        {
        ...
        {
          var that = this;
            axios.post(this.base_url+'/carinfo/list', params).then(res => {
              if(res.data.success)
              {
